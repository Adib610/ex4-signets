  ...
  return (
    <div className="AjouterDossier">
      <Dialog open={ouvert} onClose={()=>setOuvert(false)} aria-labelledby="form-dialog-title">
        ...
        <DialogActions>
        <Button onClick={()=>{setOuvert(false); viderChamps()}} style={{color: "white", backgroundColor:"red"}}  >
            Annuler
          </Button>
          <Button onClick={() => {nom !== '' && gererAjout(nom, couverture, couleur); viderChamps(); }} style={{color: "white", backgroundColor:"green"}}>
            Ajouter
          </Button>
        </DialogActions>
      </Dialog>
